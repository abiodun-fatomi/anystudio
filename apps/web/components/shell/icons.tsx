...
export const Icon = {
  studio: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base(p)}>
      <rect x="3" y="3" width="18" height="18" rx="3" />
      <path d="m3 15 4.5-4.5a2 2 0 0 1 2.8 0L15 15M13 13l1.5-1.5a2 2 0 0 1 2.8 0L21 15" />
  ...
  credits: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base(p)}>
      ...
      <path d="M9.5 9.5c.5-1 1.5-1.5 2.5-1.5 1.7 0 2.5 1 2.5 2 0 2-5 1.5-5 4 0 1 .8 2 2.5 2 1 0 2-.5 2.5-1.5M12 6.5V8m0 8v1.5" />
    </svg>
  ),
  insights: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base(p)}>
      <path d="M4 19V5M4 19h16M8 15v-4m4 4V8m4 7v-2" />
    </svg>
  ),
  ...
  publish: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base(p)}>
      <path d="M4 12v6a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-6M12 4v11m0-11-4 4m4-4 4 4" />
    </svg>
  ),
  ...
  translate: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base(p)}>
      <circle cx="12" cy="12" r="9" />
      <path d="M3 12h18M12 3c2.5 2.7 3.8 5.7 3.8 9s-1.3 6.3-3.8 9c-2.5-2.7-3.8-5.7-3.8-9S9.5 5.7 12 3Z" />
    </svg>
  ),
  lips: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base(p)}>
      <path d="M3 12c2.5-3.5 5-5 7-5 .8 0 1.4.4 2 1 .6-.6 1.2-1 2-1 2 0 4.5 1.5 7 5-2.5 3.5-5.5 5.5-9 5.5S5.5 15.5 3 12Z" />
      <path d="M3 12h18" />
    </svg>
  ),
  ...
  webhook: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base(p)}>
      <circle cx="6" cy="17" r="3" />
      <circle cx="18" cy="17" r="3" />
      <circle cx="12" cy="6" r="3" />
      <path d="M9 17h6M13.5 8.5 16 14M10.5 8.5 8 14" />
    </svg>
  ),
  ...
  collapse: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base(p)}>
