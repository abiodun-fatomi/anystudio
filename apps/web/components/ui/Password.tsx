...
const block = (e: ClipboardEvent<HTMLInputElement>) => {
  e.preventDefault();
};
...
export const PasswordInput = forwardRef<HTMLInputElement, Omit<InputProps, 'type' | 'trailing'>>(function PasswordInput({ className, ...rest }, ref) {
  ...
  return (
    <Input
      ...
      autoCapitalize="off"
      trailingInteractive
      trailing={<Eye shown={shown} onToggle={() => setShown((s) => !s)} />}
    />
  );
});
    ...
    >
      {shown ? (
        <svg
          ...
          aria-hidden="true"
        >
          <path d="M3 3l18 18M10.6 10.6a2 2 0 0 0 2.8 2.8M9.9 5.1A10.4 10.4 0 0 1 12 5c5 0 8.5 4 9.5 7-.4 1.1-1.1 2.3-2 3.3M6.6 6.6C4.6 8 3.3 10 2.5 12c1 3 4.5 7 9.5 7 1.7 0 3.2-.4 4.5-1.1" />
        </svg>
      ) : (
        <svg
          width="20"
