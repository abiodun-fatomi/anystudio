...
@Module({
  imports: [
    ...
    AuthModule, OnboardingModule, LedgerModule, WalletModule, WorkspaceModule, GenerationModule, BrandModule, AccountModule, MemberModule, BillingModule, LibraryModule, InsightsModule, AudioModule, DeveloperModule, WhatsappModule, NotificationModule, AdminModule, SupportModule,
  ],
