...
const A = 'This handmade ankara tote bag is roomy enough for a laptop and light enough for the market. Bold print, strong straps, and a zip that keeps your things safe. Made in Lagos, ready to ship.';
const B = 'This handmade ankara tote bag is roomy enough for a laptop and light enough for the market. Bold print, strong straps, and a zip that keeps your things safe. Made in Lagos in a green print, ready to ship.';
const C = 'Meet the bag that goes from Balogun market to a boardroom without changing. Wax-print cotton, reinforced base, and a laptop sleeve inside. Sewn in Lagos by hand.';
...
describe('uniqueness', () => {
  ...
  it('is deterministic and fits a Postgres integer', () => {
    const a = minhash(A); const b = minhash(A);
    expect(a).toEqual(b);
