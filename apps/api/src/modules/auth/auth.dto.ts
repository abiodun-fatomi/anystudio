...
import {
  IsBoolean, IsEmail, IsNotEmpty, IsOptional, IsString, IsUrl, IsUUID, Length, MaxLength, MinLength,
  ValidateNested,
} from 'class-validator';

export class LoginDto {
  @ApiProperty({ example: 'ada@bimbofabrics.ng', description: 'Email address or E.164 phone number' })
  @IsString() @IsNotEmpty() @Length(3, 320)
  identifier: string;
...
export class RegisterDto {
  ...
  @ValidateNested() @Type(() => MarketingConsentDto)
