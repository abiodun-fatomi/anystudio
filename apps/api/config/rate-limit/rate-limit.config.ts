...
export const RATE_LIMITS: Record<string, RateRule[]> = {
  'POST /api/v1/auth/login': [
    { limit: 5, windowSec: 60, scope: 'ip' },
    { limit: 10, windowSec: 3600, scope: 'account' },
  ],
  'POST /api/v1/auth/login/mfa': [{ limit: 10, windowSec: 300, scope: 'ip' }],
  'POST /api/v1/auth/register': [{ limit: 3, windowSec: 3600, scope: 'ip' }],
  'POST /api/v1/auth/forgot': [
    { limit: 3, windowSec: 3600, scope: 'ip' },
    { limit: 3, windowSec: 3600, scope: 'account' },
  ],
  ...
  'POST /api/v1/support/conversations/:id/messages': [
    { limit: 20, windowSec: 60, scope: 'account' },
    { limit: 200, windowSec: 86400, scope: 'account' },
  ],
