...
| `ELEVENLABS_API_KEY`                                                       | Voiceovers (multilingual TTS), music, dubbing                                                                           | elevenlabs.io → profile menu → **API Keys → Create**. Commercial use of generated music needs the Creator plan or above.                                                                                                                                           |
...
| `HIGGSFIELD_API_KEY` + `HIGGSFIELD_API_SECRET`                             | Higgsfield's own image-to-video models (rows stay disabled until resale terms are agreed)                               | platform.higgsfield.ai → **API keys** → key and secret pair.                                                                                                                                                                                                       |
